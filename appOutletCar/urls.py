...
from . import views
from .views import IndexView, AboutView, MarcaDetailView, CategoriaDetailView, CocheListView, ReseñaCocheView, GetCategoriesByBrandView, GetCarsByBrandAndCategoryView, ShowCocheView, ShowMarcaView, ShowCategoriaView
