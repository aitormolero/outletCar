...
class Marca(models.Model):
    ...
    imagen = models.ImageField(upload_to='static/img/marcas', blank=True, null=True, verbose_name=_('Image'))
...
class Coche(models.Model):
    ...
    imagen = models.ImageField(upload_to='static/img/coches', blank=True, null=True, verbose_name=_('Image'))
