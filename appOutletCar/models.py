...
class Marca (models.Model):
    ...
    imagen = models.ImageField(upload_to = 'appOutletCar/static/img/marcas', blank = True, null = True, verbose_name = 'Image')
...
class Coche (models.Model):
    ...
    imagen = models.ImageField(upload_to = 'appOutletCar/static/img/coches', blank = True, null = True, verbose_name = 'Image')
